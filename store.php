                ...
                <div class="row">
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div style="display: flex">
                                    ...
                                    <a href="http://pnaf.in">
                                        <!--<img class=" g-height-auto--xs" src="static/img/consologo.png" alt="StartUp Conclave" height="45" width="45">-->
                                        <img class="img-responsive g-padding-x-0--xs" style="height: 45px" src="img/logo-ecell.png" alt="Ecell">
                                    </a>

                                    <a href="/" style="margin-left: 20px;">
                                        <img class="img-responsive g-height-auto--xs" style="height: 45px" src="img/icon1.png" alt="Ecell Logo">
                                    </a>
                                </div>
                        <br><br>
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4 g-text-right--md">
                        <p class="g-font-size-14--xs g-margin-b-0--xs g-color--white">Copyright <a class="g-color--red" href="https://www.ecellvnit.org/" target="_blank">E-cell Vnit</a></p>
                    </div>
                </div>
            </div>
            <!-- End Copyright -->
