...
<body>
	...
	<div id="heading-of-blog">
		...
		<div id="head"><span id="date">27 AUG 2020</span><br>What is the Most Common Trait of Successful Startups?</div>
	</div>
	<div class="img">
		<img src="img/flower.jpg" alt="Flower" title="" class="content-img">
	</div>
	<div class="content">
		<!-- Image related to content of blog -->
		<div class="text">
			<!-- Quoted Text Here -->
			<div class="quote-text"><i>"There have to be reasons that you get up in the morning, and you want to live. Why do you want to live? What's the point? What inspires you? What do you love about the future? If the future does not include being out there among the stars and being a multiplanet species, I find that incredibly depressing if that's not the future that we're going to have."</i></div>
            ...
            <ul class="soc">
                <li>
                    <a class="icon-share email" href="#" title="Email">
                ...
                <li>
                    <a class="icon-share fb" href="#" title="Facebook">
                ...
                <li>
                    <a class="icon-share linkedin-share" href="#" title="LinkedIn">
                ...
                <li>
                    <a class="icon-share insta" href="#" title="Instagram">
                ...
                <li>
                    <a class="icon-share twitter" href="#" title="Twitter">
